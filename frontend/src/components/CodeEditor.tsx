...
const editorTheme = EditorView.theme({
  ...
  ".cm-panels": { backgroundColor: "var(--kt-c-s-floating)", color: "var(--kt-c-t-strong)" },
  ".cm-searchMatch": { backgroundColor: "var(--kt-c-syn-search)", outline: "var(--kt-shp-border) solid var(--kt-c-syn-search-border)" },
  "&.cm-focused": { outline: "var(--kt-shp-border-emphasis) solid var(--kt-c-a-base)", outlineOffset: "var(--kt-shp-focus-inset)" },
});
