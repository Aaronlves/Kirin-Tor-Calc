...
ERROR_TITLES = {
    ...
    "stale_revision": "模型版本已变化",
    "invalid_request": "插件请求无效",
    "unknown_identity": "模型标识不存在",
    "limit_exceeded": "请求超过公开限制",
    "job_cancelled": "任务已取消",
    "workspace_invalid": "工作区无法计算",
    "operation_failed": "数学操作失败",
    "unsupported_capability": "宿主不支持此能力",
    "permission_denied": "插件权限不足",
    "plugin_disabled": "插件不可用",
    "proposal_invalid": "插件提案无效",
    "proposal_stale": "插件提案已过期",
    "domain_error": "值域错误",
    "timeout": "计算超时",
    "unsupported": "暂不支持",
...
def _translated_message(message: str, code: str) -> str:
    ...
    fallbacks = {
        ...
        "stale_revision": "模型已经变化，请使用最新工作区状态重新开始查询。",
        "invalid_request": "请求不符合当前 Plugin capability schema。",
        "unknown_identity": "请求的 canonical ID 不存在于当前模型目录。",
        "limit_exceeded": "请求超过当前宿主公开的资源上限。",
        "job_cancelled": "任务已停止，且没有生成持久运行记录或导出物。",
        "workspace_invalid": "当前工作区或未保存草稿未能通过完整校验。",
        "operation_failed": "数学核心拒绝了参数、值域、单位或求解请求。",
        "unsupported_capability": "请检查当前宿主发布的 capability descriptor。",
        "permission_denied": "当前 Plugin contribution 没有声明所需权限。",
        "plugin_disabled": "Plugin 已停用、未批准或不再属于当前内容快照。",
        "proposal_invalid": "提案没有形成可通过完整工作区校验的候选事务。",
        "proposal_stale": "工作区或草稿基线已经变化，请基于最新 revision 重新生成提案。",
