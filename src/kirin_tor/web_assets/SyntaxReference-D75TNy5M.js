import{E as e,a as t,at as n,c as r,i,n as a,nt as o,p as s,r as c}from"./createLucideIcon-DBpTY6AY.js";import{t as l}from"./ScrollArea-CLRCHwqv.js";import{t as u}from"./Code-CudZnGDh.js";import{t as d}from"./TextInput-efNIgPHj.js";import{t as f}from"./copy-BL61AtQA.js";import{C as p,h as m}from"./index-C9lo8UhF.js";var h=n(o(),1),g=[{id:`document`,title:`文档、注释与说明`,summary:`每个 .kirin 文件只声明一个 entry。正式 ID 使用 ASCII；作者注释和长说明可以使用中文。`,keywords:[`entry`,`header`,`comment`,`prose`,`文档`,`注释`,`说明`],rules:[`文件以 @kirin 1 和 @entry ID 开始。`,`// 行是作者注释，不参与 schema。`,`成对的三个或更多连字符包围长说明文本。`],exampleTitle:`最小可计算文档`,code:`@kirin 1
@entry quick_start
...
x-label: "输入"
y-label: "结果"
`}],_=e(),v=g;function y(e){let t=document.createElement(`textarea`);t.value=e,t.readOnly=!0,t.style.position=`fixed`,t.style.opacity=`0`,document.body.append(t),t.select();let n=document.execCommand(`copy`);return t.remove(),n}function b(e,t){return!t||[e.title,e.summary,e.exampleTitle,...e.keywords,...e.rules,e.code].join(`
`).toLocaleLowerCase().includes(t.toLocaleLowerCase())}function x({initialTopic:e=null}){let[n,o]=(0,h.useState)(``),[g,x]=(0,h.useState)(v[0]?.id??``),[S,C]=(0,h.useState)(null),[w,T]=(0,h.useState)(!1),E=(0,h.useMemo)(()=>v.filter(e=>b(e,n.trim())),[n]),D=E.find(e=>e.id===g)??E[0]??null;(0,h.useEffect)(()=>{!e||!v.some(t=>t.id===e)||(o(``),x(e))},[e]);let O=async e=>{T(!1);try{if(navigator.clipboard?.writeText)await navigator.clipboard.writeText(e.code);else if(!y(e.code))throw Error(`clipboard unavailable`);C(e.id)}catch{y(e.code)?C(e.id):(C(null),T(!0))}};return(0,_.jsxs)(`div`,{className:`syntax-reference`,"aria-label":`Kirin 语法参考内容`,children:[(0,_.jsxs)(`header`,{className:`syntax-reference-header`,children:[(0,_.jsxs)(s,{children:[(0,_.jsx)(t,{className:`page-kicker`,children:`AUTHORING REFERENCE`}),(0,_.jsx)(t,{fw:680,fz:`lg`,children:`在源码旁快速确认写法`}),(0,_.jsx)(t,{c:`dimmed`,fz:`xs`,mt:4,children:`这是随应用发布的只读速查。严格语义和边界仍由当前版本校验器决定。`})]}),(0,_.jsx)(d,{"aria-label":`搜索语法参考`,leftSection:(0,_.jsx)(m,{size:14}),placeholder:`搜索输入、参数方案、分布、图表…`,value:n,onChange:e=>o(e.currentTarget.value)})]}),(0,_.jsxs)(`div`,{className:`syntax-reference-layout`,children:[(0,_.jsx)(l,{className:`syntax-reference-index`,type:`auto`,children:(0,_.jsxs)(`nav`,{"aria-label":`语法主题`,children:[(0,_.jsxs)(t,{className:`nav-group-label`,children:[E.length,` 个匹配主题`]}),E.map(e=>(0,_.jsxs)(`button`,{type:`button`,className:`syntax-reference-link`,"aria-pressed":D?.id===e.id,onClick:()=>{x(e.id),C(null),T(!1)},children:[(0,_.jsx)(`strong`,{children:e.title}),(0,_.jsx)(`small`,{children:e.keywords.slice(0,3).join(` · `)})]},e.id))]})}),(0,_.jsx)(l,{className:`syntax-reference-detail`,type:`auto`,children:D?(0,_.jsx)(`article`,{"aria-labelledby":`syntax-reference-${D.id}`,children:(0,_.jsxs)(a,{gap:`lg`,children:[(0,_.jsxs)(s,{children:[(0,_.jsxs)(r,{gap:`xs`,mb:`xs`,children:[(0,_.jsx)(i,{variant:`outline`,color:`gray`,children:`Kirin v1`}),(0,_.jsx)(i,{variant:`light`,color:`orange`,children:`只读参考`})]}),(0,_.jsx)(t,{id:`syntax-reference-${D.id}`,component:`h2`,fw:700,fz:`xl`,children:D.title}),(0,_.jsx)(t,{c:`dimmed`,fz:`sm`,mt:`xs`,lh:1.65,children:D.summary})]}),(0,_.jsxs)(`section`,{"aria-label":`${D.title}规则`,children:[(0,_.jsx)(t,{className:`page-kicker`,mb:`xs`,children:`规则`}),(0,_.jsx)(`ul`,{className:`syntax-reference-rules`,children:D.rules.map(e=>(0,_.jsx)(`li`,{children:e},e))})]}),(0,_.jsxs)(`section`,{className:`syntax-example`,"aria-label":`${D.title}示例`,children:[(0,_.jsxs)(r,{justify:`space-between`,wrap:`nowrap`,className:`syntax-example-toolbar`,children:[(0,_.jsxs)(s,{children:[(0,_.jsx)(t,{className:`page-kicker`,children:`可校验示例`}),(0,_.jsx)(t,{fw:650,fz:`sm`,mt:3,children:D.exampleTitle})]}),(0,_.jsx)(c,{variant:`default`,size:`xs`,leftSection:S===D.id?(0,_.jsx)(p,{size:13}):(0,_.jsx)(f,{size:13}),"aria-label":`复制示例：${D.title}`,onClick:()=>{O(D)},children:S===D.id?`已复制`:`复制示例`})]}),(0,_.jsx)(`pre`,{children:(0,_.jsx)(u,{component:`code`,children:D.code})}),(0,_.jsx)(t,{c:w?`red`:`dimmed`,fz:`xs`,className:`syntax-example-note`,children:w?`浏览器拒绝了剪贴板访问；可以直接选择上方源码复制。`:`复制只写入剪贴板，不会修改当前文档。粘贴后仍需按所在工作区的语义执行完整校验。`})]})]})}):(0,_.jsxs)(a,{className:`syntax-reference-empty`,align:`center`,justify:`center`,gap:`xs`,children:[(0,_.jsx)(m,{size:26}),(0,_.jsx)(t,{fw:650,children:`没有匹配的语法主题`}),(0,_.jsx)(t,{c:`dimmed`,fz:`xs`,children:`换一个关键词，例如“输入”“分布”或“图表”。`})]})})]})]})}export{x as SyntaxReference};