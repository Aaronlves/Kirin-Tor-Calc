...
- [Plugin API 2 SDK](sdk/plugin/kirin-plugin-sdk.d.mts)：生成式 ESM SDK、类型与 action/job 合同。
- [可规模化游戏插件平台提案](docs/scalable-game-plugin-platform-proposal.md)：Package、Catalog、Plugin API、SDK、可信呈现和验收路线；Phase 0–3 已实现，Phase 4 仍是提案。
